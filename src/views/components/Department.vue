    ...
    <Card style="width:100%;">
      <form class="el-form">
        <div class="el-form-item col col-sm-12 col-xs-24">
          ...
          <Button type="text">上海邮乐网络技术有限公司</Button>
        </div>
        <div class="el-form-item col col-sm-24 col-xs-24">
          <label class="el-form-item__label " style="width: 80px; ">部门名称</label>
          <Input placeholder="输入框" label="用户名" v-model="inputVal" clearable class="col col-sm-10" />
        </div>
        <div class="el-form-item col col-sm-24 col-xs-24">
        ...
        <div class="el-form-item col col-sm-24 col-xs-24">
          ...
          <Select v-model="hobby" placeholder="请选择" :list="options" class="col col-sm-10"></Select>
        </div>
        <div class="el-form-item col col-sm-24 col-xs-24">
          <label class="el-form-item__label " style="width: 80px; ">上级部门</label>
          <Select v-model="selectVal" placeholder="请选择" :list="options" class="col col-sm-10" filterable></Select>
        </div>
        <div class="el-form-item col col-sm-24 col-xs-24">
          <label class="el-form-item__label " style="width: 80px; ">部门正职</label>
          <Select v-model="hobby" placeholder="请选择" :list="options" class="col col-sm-10" filterable></Select>
        </div>
        <div class="el-form-item col col-sm-24 col-xs-24">
        ...
        <div class="el-form-item col col-sm-24 col-xs-24">
          ...
          <Switchs v-model="value5" active-color="#13ce66" inactive-color="#ff4949" active-value="1" inactive-value="0"></Switchs>
        </div>
        <div class="el-form-item col col-sm-24 col-xs-24">
          <label class="el-form-item__label " style="width: 80px; ">部门职责</label>
          <Input label="部门职责" type="textarea" placeholder="部门职责" v-model="formItem.textarea" rows="3" class="col col-sm-10" />
        </div>
